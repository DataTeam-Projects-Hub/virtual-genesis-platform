...
def main():
    block_list = [
        30262331, 30345132, 30388689, 30483931,
        30523773, 30564766, 30609799, 30613358, 30645758, 30652067, 30660164, 30687158,
        30690459, 30704109, 30728578, 30732159, 30778059, 30782628, 30826631, 30863563,
        30871891, 30917744, 30948304, 30996763, 31035462, 31055290, 31086775, 31122771,
        31155161, 31162358, 31171544, 31214565, 31252361, 31299314, 31300959, 31366212,
        31380008, 31430532, 31430560, 31471887, 31491759, 31551199, 31556559, 31594389,
        31597960, 31603358, 31640559, 31646558, 31657358, 31691681, 31729362, 31733046
    ]

    for block in block_list:
        print(f"\n--- Processing block {block} ---")
        persona_logs = fetch_logs(block)
        if not persona_logs:
